! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        ui: {
            insertButton: ".UltraThemeLibrary__insert-button"
        },
        events: {
        ...
        template: "#tmpl-UltraThemeLibrary__empty",
        ui: {
        ...
        template: "#tmpl-UltraThemeLibrary__loading",
        id: "UltraThemeLibrary__loading"
    }), a.Views.Logo = Marionette.ItemView.extend({
        template: "#tmpl-UltraThemeLibrary__header-logo",
        className: "UltraThemeLibrary__header-logo",
        ...
        template: "#tmpl-UltraThemeLibrary__header-back",
        id: "elementor-template-library-header-preview-back",
        className: "UltraThemeLibrary__header-back",
        events: function() {
            return {
                click: "onClick"
            }
        ...
        template: "#tmpl-UltraThemeLibrary__header-menu",
        id: "elementor-template-library-header-menu",
        className: "UltraThemeLibrary__header-menu",
        templateHelpers: function() {
        ...
        template: "#tmpl-UltraThemeLibrary__header-menu-responsive",
        id: "elementor-template-library-header-menu-responsive",
        className: "UltraThemeLibrary__header-menu-responsive",
        ui: {
        ...
        template: "#tmpl-UltraThemeLibrary__header-actions",
        id: "elementor-template-library-header-actions",
        ui: {
            sync: "#UltraThemeLibrary__header-sync i"
        },
        events: {
        ...
        template: "#tmpl-UltraThemeLibrary__header-insert",
        ...
        template: "#tmpl-UltraThemeLibrary__preview",
        className: "UltraThemeLibrary__preview",
        ui: function() {
            return {
                iframe: "> iframe"
            }
        ...
        onRender: function() {
            ...
            this.$el.append(t.el), this.ui.iframe.on("load", function() {
                e.$el.find("#UltraThemeLibrary__loading").remove(), e.ui.iframe.show()
            })
        }
    }), a.Views.TemplateCollection = Marionette.CompositeView.extend({
        template: "#tmpl-UltraThemeLibrary__templates",
        id: "UltraThemeLibrary__templates",
        className: function() {
            return "UltraThemeLibrary__templates UltraThemeLibrary__templates--" + i.library.getFilter("type")
        },
        childViewContainer: "#UltraThemeLibrary__templates-list",
        emptyView: function() {
            return new a.Views.EmptyTemplateCollection
        },
        ui: {
            templatesWindow: ".UltraThemeLibrary__templates-window",
            textFilter: "#UltraThemeLibrary__search",
            tagsFilter: "#UltraThemeLibrary__filter-tags",
            filterBar: "#UltraThemeLibrary__toolbar-filter",
            counter: "#UltraThemeLibrary__toolbar-counter"
        },
        events: {
        ...
        onTagsFilterClick: function(t) {
            var a = e(t.currentTarget),
                n = a.data("tag");
            i.library.setFilter("tags", n), a.addClass("active").siblings().removeClass("active"), n = n ? i.library.getTags()[n] : "Filter", this.ui.filterBar.find(".UltraThemeLibrary__filter-btn").html(n + ' <i class="eicon-caret-down"></i>')
        },
        ...
        setTagsFilterHover: function() {
            ...
            e.ui.filterBar.hoverIntent(function() {
                e.ui.tagsFilter.css("display", "block"), e.ui.filterBar.find(".UltraThemeLibrary__filter-btn i").addClass("eicon-caret-down").removeClass("eicon-caret-right")
            }, function() {
                e.ui.tagsFilter.css("display", "none"), e.ui.filterBar.find(".UltraThemeLibrary__filter-btn i").addClass("eicon-caret-right").removeClass("eicon-caret-down")
            }, {
                sensitivity: 50,
                interval: 150,
                timeout: 100
        ...
        template: "#tmpl-UltraThemeLibrary__template",
        className: "UltraThemeLibrary__template",
        ui: {
            previewButton: ".UltraThemeLibrary__preview-button, .UltraThemeLibrary__template-preview"
        },
        events: {
        ...
        getTemplateActionButton: function(e) {
            ...
            return viewId = "#tmpl-UltraThemeLibrary__" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
        ...
        function i() {
            ...
            n && _.each(n, function(e, t) {
                a === e.id && (p.atIndex = t)
            }), r.find(".elementor-add-uaTheme-button").length || r.find(FIND_SELECTOR).before($openLibraryButton)
        }

        function n(e) {
            var t = e.find(FIND_SELECTOR);
            t.length && !e.find(".elementor-add-uaTheme-button").length && t.before($openLibraryButton), e.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", i)
        }
        ...
        function r(t, i) {
            ...
            e(".UltraThemeLibrary__preview").css("width", a)
        }
        ...
        function l() {
            ...
            e.on("click.onAddTemplateButton", ".elementor-add-uaTheme-button", p.showModal.bind(p)), this.channels.tabs.on("change:device", r)
        }
        var o, s, d, c, m, p = this,templateButtonText=ULTRAADDONS_DATA_EDITOR.i18n.iconTitlePreviewPage;
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-uaTheme-button"> <i class="uicon-ultraaddons"></i><span class="elementor-add-uaTheme-button-text">'+templateButtonText+'</span> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
