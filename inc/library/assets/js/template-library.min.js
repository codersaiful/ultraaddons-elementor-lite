! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        className: function() {
            return "haTemplateLibrary__templates haTemplateLibrary__templates--" + i.library.getFilter("type")
        },
        ...
        onTagsFilterClick: function(t) {
            var a = e(t.currentTarget),
                n = a.data("tag");
            i.library.setFilter("tags", n), a.addClass("active").siblings().removeClass("active"), n = n ? i.library.getTags()[n] : "Filter", this.ui.filterBar.find(".haTemplateLibrary__filter-btn").html(n + ' <i class="eicon-caret-down"></i>')
        },
        ...
        function l() {
            ...
            e.on("click.onAddTemplateButton", ".elementor-add-ha-button", p.showModal.bind(p)), this.channels.tabs.on("change:device", r)
        }
        var o, s, d, c, m, p = this;
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-ha-button"> <i class="hm hm-happyaddons"></i> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
...
console.log(jQuery, window.elementor, window.ha);