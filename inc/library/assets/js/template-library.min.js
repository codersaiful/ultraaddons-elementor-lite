! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-ha-button"> <i class="ua ua-ultraaddons"></i> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
