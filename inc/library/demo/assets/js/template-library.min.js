! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        // UlTemplateButtonText=ULTRAADDONS_DATA_EDITOR.i18n.iconDemoTitlePreviewPage;
        ...
        // $themeDemoOpenButton = '<div class="elementor-add-section-area-button elementor-add-elm-button"> <i class="' + ELDM_DATA_EDITOR.icon + '"></i><span class="elementor-add-elm-button-text">'+demoButtonText+'</span> </div>';
        // $openELDMButton = $UL_OPEN_button + $themeDemoOpenButton;
