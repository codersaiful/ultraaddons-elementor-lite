! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-elm-button"> <i class="' + ULTRAADDONS_DATA_EDITOR.icon + '"></i><span class="elementor-add-elm-button-text">'+templateButtonText+'</span> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
