    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        function i() {
            ...
            n && _.each(n, function(e, t) {
                a === e.id && (p.atIndex = t)
            }), r.find(".elementor-add-elm-button").length || r.find(FIND_SELECTOR).before($openLibraryButton)
        }

        function n(e) {
            var t = e.find(FIND_SELECTOR);
            t.length && !e.find(".elementor-add-elm-button").length && t.before($openLibraryButton), e.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", i)
        }
        ...
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-elm-button"> <i class="' + ELDM_DATA_EDITOR.icon + '"></i><span class="elementor-add-elm-button-text">'+templateButtonText+'</span> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
