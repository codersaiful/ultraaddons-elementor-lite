    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        function i() {
            ...
            n && _.each(n, function(e, t) {
                a === e.id && (p.atIndex = t)
            }), r.find(".elementor-add-elm-button").length || r.find(FIND_SELECTOR).after($openLibraryButton)
        }

        function n(e) {
            var t = e.find(FIND_SELECTOR);
            t.length && !e.find(".elementor-add-elm-button").length && t.after($openLibraryButton), e.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", i)
        }
        ...
        var o, s, d, c, m, p = this,templateButtonText=ELDM_DATA_EDITOR.i18n.iconTitlePreviewPage;
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", 
        
        UlTemplateButtonText=ULTRAADDONS_DATA_EDITOR.i18n.iconTitlePreviewPage;
        $UL_OPEN_button = '<div class="elementor-add-section-area-button elementor-add-ua-button"> <i class="uicon-ultraaddons"></i><span class="elementor-add-ua-button-text">'+UlTemplateButtonText+'</span> </div>';
        $themeDemoOpenButton = '<div class="elementor-add-section-area-button elementor-add-elm-button"> <i class="' + ELDM_DATA_EDITOR.icon + '"></i><span class="elementor-add-elm-button-text">'+templateButtonText+'</span> </div>';
        $openLibraryButton = $UL_OPEN_button + $themeDemoOpenButton;
        $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-elm-button"> <i class="' + ELDM_DATA_EDITOR.icon + '"></i><span class="elementor-add-elm-button-text">'+templateButtonText+'</span> </div>';
